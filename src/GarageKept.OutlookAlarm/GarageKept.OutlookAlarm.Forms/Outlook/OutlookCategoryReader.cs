...
public static class OutlookCategoryColorExtensions
{
    ...
    public static Color GetCategoryColor(this string categoryName)
    {
        ...
        var categoryColor = ((Microsoft.Office.Interop.Outlook.OlCategoryColor)category.Color).ToColor();
    ...
    public static Color ToColor(this Microsoft.Office.Interop.Outlook.OlCategoryColor olCategoryColor)
    {
